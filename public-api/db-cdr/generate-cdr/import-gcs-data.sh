...
TABLES=(achilles_analysis achilles_results achilles_results_dist domain_info survey_module domain vocabulary cb_criteria cb_criteria_attribute concept concept_relationship concept_ancestor concept_synonym domain_vocabulary_info chel_h3_cell chel_metric chel_h3_metric_value)
