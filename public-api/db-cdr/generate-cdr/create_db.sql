...
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE TEMPORARY TABLES ON ${CDR_DB_NAME}.* TO '${DATABROWSER_DB_USER}'@'%';
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE TEMPORARY TABLES ON ${CDR_DB_NAME}.* TO '${PUBLIC_DB_USER}'@'%';
