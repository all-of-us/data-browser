...
create_tables=(achilles_analysis achilles_results achilles_results_concept achilles_results_dist concept concept_relationship cb_criteria cb_criteria_attribute cb_criteria_relationship cb_criteria_ancestor fmh_metadata fmh_fm_metadata fmh_conditions_member_metadata question_concept
...
bq --quiet --project=$BQ_PROJECT query --nouse_legacy_sql \
"insert into \`${OUTPUT_PROJECT}.${OUTPUT_DATASET}.question_concept\` qc
