...
create_tables=(achilles_analysis achilles_results achilles_results_concept achilles_results_dist concept concept_relationship cb_criteria cb_criteria_attribute cb_criteria_relationship cb_criteria_ancestor fmh_metadata
...
load_tables=(domain_info survey_module achilles_analysis achilles_results unit_map survey_question_map filter_conditions source_standard_unit_map survey_concept_relationship fmh_metadata)
...
from \`${BQ_PROJECT}.${BQ_DATASET}.observation\` ob join \`${OUTPUT_PROJECT}.${OUTPUT_DATASET}.survey_concept_relationship\` cr
