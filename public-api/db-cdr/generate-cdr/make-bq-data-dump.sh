...
tables=(achilles_analysis achilles_results achilles_results_dist concept concept_relationship cb_criteria cb_criteria_relationship cb_criteria_attribute cb_criteria_ancestor domain_info survey_module domain vocabulary concept_synonym domain_vocabulary_info criteria_stratum measurement_concept_info survey_metadata chel_h3_cell chel_metric chel_h3_metric_value)
