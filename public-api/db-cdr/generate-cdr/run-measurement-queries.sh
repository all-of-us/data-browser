...
if [[ "$tables" == *"_mapping_"* ]]; then
    ...
    select 0, 3000 as analysis_id,
      ...
      'Measurement' as stratum_3,
    	COUNT(distinct co1.PERSON_ID) as count_value, (select COUNT(distinct co2.person_id) from \`${BQ_PROJECT}.${BQ_DATASET}.v_full_measurement\` co2
    	where co2.measurement_source_concept_id=co1.measurement_concept_id) as source_count_value
    from \`${BQ_PROJECT}.${BQ_DATASET}.v_full_measurement\` co1
    ...
    union all
     ...
     and co1.measurement_source_concept_id not in (select distinct measurement_concept_id from \`${BQ_PROJECT}.${BQ_DATASET}.v_full_measurement\`)
     ...
     (select COUNT(distinct co2.person_id) from \`${BQ_PROJECT}.${BQ_DATASET}.v_full_measurement\` co2 join \`${BQ_PROJECT}.${BQ_DATASET}.person\` p2 on p2.person_id=co2.person_id
     ...
     \`${BQ_PROJECT}.${BQ_DATASET}.v_full_measurement\` co1
     ...
     from \`${BQ_PROJECT}.${BQ_DATASET}.v_full_measurement\` co join \`${BQ_PROJECT}.${BQ_DATASET}.person\` p on p.person_id=co.person_id
     ...
     (select COUNT(distinct co2.PERSON_ID) from \`${BQ_PROJECT}.${BQ_DATASET}.v_full_measurement\` co2 join m_age_stratum ca2
     ...
     from \`${BQ_PROJECT}.${BQ_DATASET}.v_full_measurement\` co1 join m_age_stratum ca on co1.measurement_id = ca.measurement_id
     where co1.measurement_concept_id in (903118, 903115, 903133, 903121, 903135, 903136, 903126, 903111, 903120)
     ...
     COUNT(distinct co1.person_id) as count_value,
     COUNT(distinct co1.person_id) as source_count_value from \`${BQ_PROJECT}.${BQ_DATASET}.v_full_measurement\` co1 join m_age_stratum ca
     on co1.measurement_id = ca.measurement_id
     where co1.measurement_source_concept_id not in (select distinct measurement_concept_id from \`${BQ_PROJECT}.${BQ_DATASET}.v_full_measurement\`)
     ...
     from \`${BQ_PROJECT}.${BQ_DATASET}.v_full_measurement\` m join \`${BQ_PROJECT}.${BQ_DATASET}.person\` p on p.person_id=m.person_id
     ...
     m.measurement_source_concept_id not in (select distinct measurement_concept_id from \`${BQ_PROJECT}.${BQ_DATASET}.v_full_measurement\`)
     ...
     where m.value_as_number is not null and m.measurement_concept_id in (903118, 903115, 903133, 903121, 903135, 903136, 903126, 903111, 903120) and m.unit_concept_id = 0 and m.unit_source_value is not null
     union all
     ...
     and m.measurement_source_concept_id not in (select distinct measurement_concept_id from \`${BQ_PROJECT}.${BQ_DATASET}.v_full_measurement\`)
     ...
     count(distinct p1.person_id) as count_value,
     count(distinct p1.person_id) as source_count_value
     from \`${BQ_PROJECT}.${BQ_DATASET}.v_full_measurement\` m1 join \`${BQ_PROJECT}.${BQ_DATASET}.person\` p1 on p1.person_id = m1.person_id
     ...
     and (m1.unit_concept_id != 0 or m1.unit_source_value is not null)
     ...
     and m1.measurement_source_concept_id not in (select distinct measurement_concept_id from \`${BQ_PROJECT}.${BQ_DATASET}.v_full_measurement\`)
     and m1.value_as_number is not null and p1.gender_concept_id=gender and cast(um.unit_concept_id as string)=unit
     and (m1.unit_concept_id != 0 or m1.unit_source_value is not null)
     group by stratum_1, stratum_2, stratum_3, stratum_4"
     ...
     "insert into \`${WORKBENCH_PROJECT}.${WORKBENCH_DATASET}.achilles_results\`
      ...
      count(distinct p1.person_id) as count_value,
      count(distinct p1.person_id) as source_count_value
      FROM \`${BQ_PROJECT}.${BQ_DATASET}.v_full_measurement\` m1
      ...
      (select COUNT(distinct co2.person_id) from \`${BQ_PROJECT}.${BQ_DATASET}.v_full_measurement\` co2 join \`${BQ_PROJECT}.${BQ_DATASET}.person\` p1
      ...
      where m.measurement_concept_id in (903118, 903115, 903133, 903121, 903135, 903136, 903126, 903111, 903120) and m.unit_source_value is not null and m.unit_concept_id = 0
...
and m1.value_as_number is not null and p1.gender_concept_id=gender and cast(um.unit_concept_id as string)=unit
and and (m1.unit_concept_id != 0 or m1.unit_source_value is not null)
group by stratum_1, stratum_2, stratum_3, stratum_4
union all
select 0 as id, 1900 as analysis_id,
CAST(m1.measurement_source_concept_id AS STRING) as stratum_1,
