...
public class GenomicsController implements GenomicsApiDelegate {
    ...
    private static final String svVariantIdRegexV7 = "(?i)AoUSVPhase[a-zA-Z0-9]{1,2}\\.chr[1-9XY][0-9]?(?:\\.final_cleanup_)?(BND|DUP|DEL|INS|CPX|INV|CTX|CNV)(?::ME:(?:ALU|SVA|LINE1|HERVK))?_chr[1-9XY][0-9]?_\\d+";

    private static final String svVariantIdRegexV8 = "(?i)AoUSVPhase[a-zA-Z0-9]{1,2}\\.(BND|DUP|DEL|INS|CPX|INV|CTX|CNV)(?::ME:(?:ALU|SVA|LINE1|HERVK))?_chr[1-9XY][0-9]?_shard[0-9][0-9]?_\\d+";
