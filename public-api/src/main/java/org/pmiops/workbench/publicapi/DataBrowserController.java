...
public class DataBrowserController implements DataBrowserApiDelegate {
    ...
    private static final Function<QuestionConcept, org.pmiops.workbench.model.QuestionConcept>
            ...
            new Function<QuestionConcept, org.pmiops.workbench.model.QuestionConcept>() {
                ...
                public org.pmiops.workbench.model.QuestionConcept apply(QuestionConcept concept) {
                    org.pmiops.workbench.model.SurveyQuestionAnalysis countAnalysis=null;
                    org.pmiops.workbench.model.SurveyQuestionAnalysis genderAnalysis=null;
                    org.pmiops.workbench.model.SurveyQuestionAnalysis ageAnalysis=null;
                    org.pmiops.workbench.model.SurveyQuestionAnalysis genderIdentityAnalysis=null;
     ...
     * client representation (generated by Swagger).
     */
    private static final Function<AchillesAnalysis, org.pmiops.workbench.model.SurveyQuestionAnalysis>
            TO_CLIENT_SURVEY_ANALYSIS =
            new Function<AchillesAnalysis, org.pmiops.workbench.model.SurveyQuestionAnalysis>() {
                @Override
                public org.pmiops.workbench.model.SurveyQuestionAnalysis apply(AchillesAnalysis cdr) {
                    List<org.pmiops.workbench.model.SurveyQuestionResult> results = new ArrayList<>();
                    if (!cdr.getResults().isEmpty()) {
                        results = cdr.getResults().stream().map(TO_CLIENT_SURVEY_RESULT).collect(Collectors.toList());
                    }

                    return new org.pmiops.workbench.model.SurveyQuestionAnalysis()
                            .analysisId(cdr.getAnalysisId())
                            .analysisName(cdr.getAnalysisName())
                            .stratum1Name(cdr.getStratum1Name())
                            .stratum2Name(cdr.getStratum2Name())
     ...
     * client representation (generated by Swagger).
     */
    private static final Function<AchillesResult, org.pmiops.workbench.model.SurveyQuestionResult>
            TO_CLIENT_SURVEY_RESULT =
            new Function<AchillesResult, org.pmiops.workbench.model.SurveyQuestionResult>() {
                @Override
                public org.pmiops.workbench.model.SurveyQuestionResult apply(AchillesResult o) {

                    return new org.pmiops.workbench.model.SurveyQuestionResult()
                            .id(o.getId())
                            .analysisId(o.getAnalysisId())
                            .stratum1(o.getStratum1())
                            .stratum2(o.getStratum2())
        ...
        for(QuestionConcept q: subQuestions) {
            ...
            for(SurveyQuestionMap sqm: questionPaths) {
                ...
                if (conceptPath.size() == 3) {
                    ...
                    org.pmiops.workbench.model.SurveyQuestionResult matchingSurveyResult = mainQuestion.getCountAnalysis().getSurveyQuestionResults().stream().filter(mr -> mr.getStratum3().equals(String.valueOf(resultConceptId))).collect(Collectors.toList()).get(0);
                    ...
                    org.pmiops.workbench.model.SurveyQuestionResult matchingSurveyResult1 = mainQuestion1.getCountAnalysis().getSurveyQuestionResults().stream().filter(mr -> mr.getStratum3().equals(String.valueOf(resultConceptId1))).collect(Collectors.toList()).get(0);
                    org.pmiops.workbench.model.QuestionConcept mainQuestion2 = matchingSurveyResult1.getSubQuestion();
                    org.pmiops.workbench.model.SurveyQuestionResult matchingSurveyResult2 = mainQuestion2.getCountAnalysis().getSurveyQuestionResults().stream().filter(mr -> mr.getStratum3().equals(String.valueOf(resultConceptId2))).collect(Collectors.toList()).get(0);
