...
public class DataBrowserController implements DataBrowserApiDelegate {
    ...
    @Override
    public ResponseEntity<SurveyQuestionFetchResponse> getSurveyQuestions(Long surveyConceptId) {
        try {
            CdrVersionContext.setCdrVersionNoCheckAuthDomain(defaultCdrVersionProvider.get());
        } catch(NullPointerException ie) {
            throw new ServerErrorException("Cannot set default cdr version");
        ...
        // TODO
        // Change and filter on search word
    ...
    @Override
    public ResponseEntity<SurveyQuestionFetchResponse> getFMHQuestions(Long surveyConceptId, List<String> questionConceptIds) {
        try {
            CdrVersionContext.setCdrVersionNoCheckAuthDomain(defaultCdrVersionProvider.get());
        } catch(NullPointerException ie) {
            throw new ServerErrorException("Cannot set default cdr version");
    ...
    public ResponseEntity<SurveyVersionCountResponse> getSurveyVersionCounts(Long surveyConceptId) {
        ...
        analysisIds.add(3400L);
        analysisIds.add(3401L);
        List<AchillesAnalysis> surveyAnalysisList = achillesAnalysisDao.findAnalysisByIds(analysisIds);
    ...
    public ResponseEntity<CountAnalysis> getCountAnalysis(String domainId, String domainDesc) {
        ...
        if (domainDesc.equals("ehr")) {
            ...
            List<AchillesAnalysis> ehrAnalysesList = achillesAnalysisDao.findAnalysisByIdsAndDomain(analysisIds, domainId);
    ...
    public ResponseEntity<ConceptAnalysisListResponse> getConceptAnalysisResults(List<String> conceptIds, String domainId){
        ...
        List<AchillesAnalysis> ehrAnalysesList = achillesAnalysisDao.findAnalysisByIdsAndDomain(countAnalysisIds, domainId);
