...
public class CommonStorageEnums {
  ...
  private static final BiMap<AnalysisIdConstant, Long> ANALYSIS_ID_MAP =
          ImmutableBiMap.<AnalysisIdConstant, Long>builder()
                  ...
                  .put(AnalysisIdConstant.AGE_GENDER_COMBINED_ANALYSIS_ID, 3105L)
                  ...
                  .put(AnalysisIdConstant.SURVEY_COMBINED_AGE_SEX_ANALYSIS_ID, 3115L)
                  ...
                  .put(AnalysisIdConstant.GENO_COMBINED_AGE_GENDER_ANALYSIS, 3505L)
