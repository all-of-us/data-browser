...
public class AchillesAnalysisService {
    ...
    public Analysis findAnalysisByIdAndDomain(Long analysisId, String domainId) {
        return achillesMapper.dbModelToClient(achillesAnalysisDao.findAnalysisByIdAndDomain(analysisId, domainId));
    }
    ...
    public List<SurveyMetadata> mapAnalysesToQuestions(List<Analysis> analyses, List<SurveyMetadata> questions, Long surveyConceptId) {
        ...
        for(SurveyMetadata q: questions) {
            ...
            if (ageAnalysis != null) {
                Analysis aa = achillesMapper.makeCopyAnalysis(participantCountAnalysis);
                aa.setResults(new ArrayList<>(
