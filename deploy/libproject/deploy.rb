...
require_relative "../../public-api/libproject/devstart"
require_relative "../../public-api/libproject/gcloudcontext"
...
def deploy(cmd_name, args)
  ...
  if op.opts.account == "aou-db-test@appspot.gserviceaccount.com"
    ...
    raise ArgumentError.new(
        ...
        "'circle-deploy-account@aou-db-test.iam.gserviceaccount.com' " +
