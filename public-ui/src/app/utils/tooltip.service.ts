...
export class TooltipService {
 ...
 including blood pressure, heart rate, height, weight, waist and hip circumference,
  ...
  pmValueChartHelpText = `Values of physical measurements taken at the time of
    participant enrollment, including blood pressure, heart rate, height, weight,
    waist and hip circumference, pregnancy status and wheelchair use.`;
