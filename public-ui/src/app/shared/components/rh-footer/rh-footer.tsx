...
import {
  menuItems,
  socialLinks,
} from "app/shared/services/header-footer.service";
          ...
          <div style={{ background: "transparent" }}>
            <div className="footer-logo">
              <div style={styles.siteLogo}>
                ...
                >
                  <img
                    src="/assets/db-images/allofus_research-hub_white.png"
                    style={{ minWidth: "9rem" }}
        ...
        <div className="footer-layout">
          <ul className="main-menu">
            {menuItems.map((menu, m) => (
              <li key={m} style={styles.mainMenuItem}>
                <a href={menu.url} style={styles.mainMenuItemLink}>
                  {menu.title}
                </a>
                  ...
                  <ul className="sub-menu">
                    {menu.submenu.map((sub, s) => (
                      <li
                        key={s}
                        className={
                          "menu-item-has-children: sub.submenu, flip: showSub1"
                        }
                      >
                        <a href={sub.url}>{sub.title}</a>
                        {sub.submenu.length > 0 && (
                          <ul>
                            {sub.submenu.map((sub1, s1) => (
                              <li key={s1}>
                                <a href="">{sub1.title}</a>
                              </li>
                            ))}
        ...
        <div className="db-container">
          <div className="cta-layout">
            <div className="cta-col">
              <p>
                Learn more about becoming a participant at{" "}
                <a
                  href="https://joinallofus.org"
                  target="_blank"
                  rel="noopener"
                >
                  JoinAllofUs.org
            ...
            <div className="cta-col">
              <p>
                Learn more about the program protocol, leadership, and
                governance at&nbsp;
                <a
          ...
          <div className="footer-boiler">
            <section>
              <p>
                ...
                Future of Health Begins With You&#8221; are service marks of
                the&nbsp;
                <a
