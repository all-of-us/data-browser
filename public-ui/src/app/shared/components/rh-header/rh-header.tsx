...
export class RhHeader extends React.Component<{}, State> {
  ...
  render() {
    const { menuOpen, searchTerms, submenusOpen1,submenusOpen2,submenusOpen3,submenusOpen4 } = this.state;
    return (
      <React.Fragment>
              ...
              <nav id="rh-site-navigation" className="nav__" aria-label="Top Menu">
                <div className="menu-primary-container">
                  <ul id="menu-primary" className="nav__items main-menu">
                    <li onClick={() => this.setState({ submenusOpen1: !submenusOpen1 })} id="menu-item-4088" className={"menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-4088 " + (submenusOpen1 ? "sub--nav--open" : "")} ><a href="https://www.researchallofus.org/about/">About</a><div className="item-expand" />
                    ...
                    <li onClick={() => this.setState({ submenusOpen2: !submenusOpen2 })} id="menu-item-3760" className={"menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-3760 " + (submenusOpen2 ? "sub--nav--open" : "")}><a href="https://www.researchallofus.org/data-tools/">Data &amp; Tools</a><div className="item-expand" />
                      <ul className="sub-menu">
                    ...
                    <li onClick={() => this.setState({ submenusOpen3: !submenusOpen3 })} id="menu-item-4089" className={"menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-4089 " + (submenusOpen3 ? "sub--nav--open" : "")}><a href="https://www.researchallofus.org/discover/">Discover</a><div className="item-expand" />
                      <ul className="sub-menu">
                    ...
                    <li onClick={() => this.setState({ submenusOpen4: !submenusOpen4 })} id="menu-item-5423" className={"menu-item menu-item-type-custom menu-item-object-custom menu-item-5423 " + (submenusOpen4 ? "sub--nav--open" : "")}><a href="https://aousupporthelp.zendesk.com/hc/en-us">Support</a><div className="item-expand" /></li>
