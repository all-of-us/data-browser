...
const helptexts = { 'QuickSearchPopup': {
    ...
    statement: <div className="card-body">
                                   <i>All of Us</i> Research Program data are not representative of the population of the United States.
  ...
  'CopePopUp': {
    ...
    statement: <div className='card-body'>
                                   ...
                                   <span className='cope-statement-body'>This optional survey was released to participants for completion
                                   ...
                                   <span className='cope-statement-body'>This survey has multiple versions. Even though most of the content is consistent between
                                       versions, some questions were modified.</span>
