                            ...
                            <div style={styles.popTableBody}>
                                {variantPopulationDetails.map((item, index) => {
                                    ...
                                    return <div key={index} style={styles.popTable}>
                                        ...
                                        <div style={styles.popTableData}>{item.Ancestry !== 'Total' ?
                                            <React.Fragment>{item.AlleleFrequency !== 0 ?
                                            item.AlleleFrequency.toFixed(6) : '0.0'}</React.Fragment>
                                            : <span style={styles.catHeading}>{item.AlleleFrequency !== 0 ?
                                            item.AlleleFrequency.toFixed(6) : '0.0'}</span>}</div>
                                    </div>;
                                })}
                            </div>
                        </div>
