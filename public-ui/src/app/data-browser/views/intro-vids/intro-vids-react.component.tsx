...
export const IntroVidReactComponent = withRouteData(class extends React.Component {
    render() {
        return <div className='db-container'>
            <h1 className='primary-display' style={{textAlign: 'center', padding: '1rem'}}>
                Introductory Videos
            </h1>
