...
export class ConceptRowReactComponent extends React.Component<Props, State> {
  ...
  participantPercentage(count: number) {
    ...
    return !count || count <= 0
      ? 0
      : parseFloat(((count / totalParticipants) * 100).toFixed(2));
  }
  ...
  render() {
    ...
    const tabIndex = 0;
    const tooltipAction =
      "Concept synonyms tooltip hover on concept " + concept.conceptName;
    ...
    const tblClass =
      domain.name.toLowerCase() === "labs & measurements"
        ? "tbl-r-labs"
        : "tbl-r";
    const codeMatchText =
      match === "source"
        ...
        <div id={id} ref={this.myRef}>
          ...
          >
            ...
            >
              ...
              <div className="body-lead tbl-d" style={styles.bodyLead}>
                {concept.countValue <= 20 && <span>&le; </span>}{" "}
              ...
              {domain.name.toLowerCase() === "labs & measurements" &&
                concept.measurementConceptInfo && (
              ...
              <div
                className="body-lead tbl-d icon-btn-group"
              ...
              >
                <button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    this.showChart("non-sources");
                  }}
                >
                  <ClrIcon
                    shape="bar-chart"
                    className={
                      showConceptChart && graphToShow !== GraphType.Sources
                        ? "is-solid icon-choice"
                        : "icon-choice"
                    }
            ...
            {domain.name.toLowerCase() === "drug exposures" &&
              concept.drugBrands &&
              concept.drugBrands.length > 0 && (
                <div className="body-lead aka-layout aka" style={styles.aka}>
                  <div className="aka-text" style={styles.akaText}>
                    <span className="drug-brands-meta">
                      Found in these commercially branded products
                    </span>
                    <div>
                      <a
                        tabIndex={tabIndex}
                        className="toggle-link brands-link"
...
export class ConceptRowWrapperComponent extends BaseReactWrapper {
  ...
  constructor() {
    super(ConceptRowReactComponent, [
      "concept",
      "domain",
      "totalResults",
      "maxResults",
