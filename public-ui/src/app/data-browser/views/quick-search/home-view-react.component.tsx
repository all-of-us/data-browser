        ...
        render() {
            ...
            return <React.Fragment>
                ...
                <p style={{ ...styles.dBDesc, ...globalStyles.bodyLead }}>
                    ...
                    Currently, participant-provided information, including data from surveys, wearables, physical measurements taken at the time of participant enrollment,
                    and electronic health records (EHR) are available. EHR data are reported by health care providers and are not participant reported.
                    The <i>All of Us</i> Research Program data will include more data types over time.<br /><br />
