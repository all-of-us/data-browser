...
export const SourceTreeComponent = class extends React.Component<
  SourceTreeProps,
  SourceTreeState
> {
      ...
      <React.Fragment>
        <div
          style={
            node.group
              ? { ...styles.treeRow }
              : { ...styles.treeRow, ...styles.noChildren }
          }
          onClick={(e) => {
            e.stopPropagation();
          }}
        >
          {node.group && (
            <ClrIcon
              ...
              style={styles.handle}
              shape="caret"
              dir={isHandelSelected ? "down" : "right"}
            />
          )}
          <span
            onClick={(e) => {
            ...
            style={
              selectedTreeConcept === parseInt(node.conceptId, 10)
                ? { ...styles.treeActive }
                : {}
            }
          >
