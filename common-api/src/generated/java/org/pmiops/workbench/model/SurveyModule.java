...
public class SurveyModule   {
  ...
  **/
   ...
   * @return orderNumber
  **/
  @ApiModelProperty(value = "survey release order number")
  ...
  public SurveyModule canShow(Integer canShow) {
    this.canShow = canShow;
    return this;
  }

   /**
   * determines if this survey can be displayed
   * @return canShow
  **/
  @ApiModelProperty(value = "determines if this survey can be displayed")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.conceptId, surveyModule.conceptId) &&
        ...
        Objects.equals(this.canShow, surveyModule.canShow);
  }

  @Override
  public int hashCode() {
    return Objects.hash(conceptId, name, description, questionCount, participantCount, orderNumber, canShow);
  }
