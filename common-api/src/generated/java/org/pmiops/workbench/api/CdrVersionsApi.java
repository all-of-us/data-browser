...
public interface CdrVersionsApi {
    ...
    @ApiOperation(value = "", notes = "Returns all curated data repository (CDR) versions that the user has access to", response = CdrVersionListResponse.class, tags={ "cdrVersions", })
    @ApiResponses(value = { 
